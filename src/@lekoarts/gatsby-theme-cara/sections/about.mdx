...
Based out of Montreal, Canada, our team is made up of passionate techies who are champions of the web. Our go-to tech stack includes **JavaScript/Typescript**, **ReactJS**, **NextJS**, **ReactNative**, **Styled Components**, **NodeJS**, **Express**, **HTML & CSS**, **Google Cloud Platform**, **Firebase**, **Amazon Web Services**, and **Wordpress**.
